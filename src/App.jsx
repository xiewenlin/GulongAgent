    ...
    <div className="site-app">
      ...
      {pathname !== "/agent" && <footer className="site-footer">
        <div className="footer-main section-shell">
          ...
          <div><h3>产品</h3><button onClick={() => navigate("/manual")}>产品手册</button><button onClick={() => navigate("/brain")}>第二大脑</button><button onClick={() => navigate("/workflows")}>工作流</button><button onClick={() => navigate(SHORT_DRAMA_ROUTE)}>短剧</button><button onClick={() => navigate("/worker")}>威客</button><button onClick={() => navigate("/pricing")}>订阅与定价</button></div>
